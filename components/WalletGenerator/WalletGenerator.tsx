...
const WalletGenerator = () => {
  ...
  const generateWalletFromMnemonic = (pathType: string, mnemonic: string, accountIndex: number) => {
    try {
    ...
    <div className="flex flex-col gap-4">
              ...
              >
                <div className="flex flex-col gap-8">
                  <h1 className="tracking-tighter text-4xl md:text-5xl font-black">
                    3Wallet supports multiple blockchains
                  </h1>
      ...
      {mnemonicWords && wallets.length > 0 && (
        ...
        >
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold tracking-tighter">Your Secret Phrase</h2>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action cannot be undone. This will permanently delete your wallets and
